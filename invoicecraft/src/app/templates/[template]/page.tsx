...
export default function TemplatePage({ params }: { params: { template: string } }) {
  ...
  const handleClientChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    if (selectedClient) {
      setInvoice({ ...invoice, clientName: selectedClient.name });
    }
  };
          ...
          <div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div>
                ...
                {session && (
                  <div className="mb-4">
                    <label htmlFor="client" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Select Client</label>
                    <select
                      id="client"
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-gray-700 dark:border-gray-600 dark:text-white"
